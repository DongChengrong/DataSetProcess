...
in_path = r'/home/lab611/dcr/datasets/split_1/local1/training/annotations'
output_path = r'/home/lab611/dcr/datasets/split_1/local1/annotations'
...
if __name__ == '__main__':
    files = [os.path.basename(path).split('.')[0] for path in glob(in_path + '/*.png')]
