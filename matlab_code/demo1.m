...
% 设置颜色
color_hFit = ColorPM(320);
color_hE = ColorPM(302);
color_hModel = ColorPM(152);
color_hData = ColorPM(124);
color_hCI1 = ColorPM(333);
color_hCI2 = ColorPM(333);
...
set(hData, 'Marker', 'o', 'MarkerSize', 6, ...
